<template>
    <div>
        <h1>Clean Code</h1>
        <br>
        <p class="pt-1 pl-5 pr-5">
            <ol> <h4> <strong> Materi Mempelajari</strong></h4> 
                <li class="mx-5">Apa itu clean code</li>
                <li class="mx-5"> Kenapa Clean Code</li>
                <li class="mx-5"> Karakteristik Clean Code</li>
            </ol>
        </p>
        <div class="mx-5">
        <p class="pt-1 pl-5 pr-5">Clean Code adalah istilah untuk kode yang mudah dibaca, difahami dan diubah oleh programmer.
            <br>
            <br>
            Kenapa Clean Code?
            <br>
            ...
            <ul>
                ...
                <li>Singkat namun mendekripsikan konteks</li>
                <li>Konsisten</li>
                <li>Hindari penambahan konteks yang tidak perlu</li>
                <li>Komentar</li>
                <li>Good function</li>
                <li>Gunakan konversi</li>
                <li>Formatting</li>
            </ul>
        </p>
        </div>
